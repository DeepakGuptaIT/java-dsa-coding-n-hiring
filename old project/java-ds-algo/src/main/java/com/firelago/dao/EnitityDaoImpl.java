...
import com.firelago.Constants;
import com.firelago.Constants.Gender;
import com.firelago.vo.Dept;
import com.firelago.vo.Emp;
import com.firelago.vo.Person;
...
//		System.out.println(getAllPerson());
	...
	private static List<Emp> getEmpByGender(Gender gender) {
